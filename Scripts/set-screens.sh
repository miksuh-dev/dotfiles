...
elif [[ $HDMI1 -eq 0 && $DP1 -eq 0 && $EDP1 -eq 0 ]]; then
  # Home screens - Work PC
  if [ "$HOSTNAME" = "debian" ]; then
    xrandr --output HDMI-1 --mode 2560x1440 --pos 0x0 --rate 60 --rotate left
    xrandr --output DP-1 --mode 2560x1440  --pos 1440x560 --rate 60 --primary
    xrandr --output eDP-1 --mode 1920x1080 --pos 4000x560 --rate 60
  fi
