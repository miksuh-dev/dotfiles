...
-- base7 = util.shade_color(base, 525),
-- base8 = util.shade_color(base, 600),
-- base9 = util.shade_color(base, 700)
...
M.load_syntax = function(palette)
  return {
    ...
    Comment = { fg = palette.base8, style = 'italic' },
    ...
    Folded = { fg = palette.base8, style = 'bold' },
    ...
    LineNr = { fg = palette.base8, bg = palette.none },
    ...
    PmenuThumb = { fg = palette.base8, bg = palette.base8 },
    ...
    StatusLine = { fg = palette.base8, bg = palette.none },
...
M.load_plugin_syntax = function(palette)
  ...
  return {
    ...
    BufferInactive = { fg = palette.base8, bg = palette.none },
    BufferInactiveIndex = { fg = palette.base8, bg = palette.none },
    BufferInactiveMod = { fg = palette.aqua, bg = palette.none },
    BufferInactiveSign = { fg = palette.base8, bg = palette.none },
    BufferInactiveTarget = { fg = palette.aqua, bg = palette.none, style = 'bold' },
    BufferTabpageFill = { fg = palette.base8, bg = palette.none },
    ...
    LspInlayHint = { fg = palette.base7, style = 'italic' },
    ...
    NeoTreeGitIgnored = { fg = palette.base8, bg = palette.none },
    ...
    ['@comment'] = { fg = palette.base8, style = 'italic' },
    ['@comment.documentation'] = { fg = palette.base8, style = 'italic' },
    ['@conceal'] = { fg = palette.grey },
    ['@conceal.json'] = {},
    ['@conceal.jsonc'] = {},
    ['@conditional'] = { fg = palette.pink },
    ...
    ['@lsp.type.testCaseName'] = { link = '@text.title' },
    ['@lsp.type.header'] = { link = 'Structure' },
    ['@lsp.type.keywordNameCall'] = { link = '@function' },
    ['@lsp.type.keywordNameDefinition'] = { link = '@function' },
    ['@lsp.type.name'] = { link = 'Constant' },
    ['@lsp.type.documentation'] = { link = '@comment' },
    ...
    ['@lsp.typemod.variable.reference'] = { fg = palette.white, style = 'NONE' },
    ['typescriptMember'] = { fg = palette.white, style = 'NONE' },
    ['typescriptFuncCallArg'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.typemod.parameter.declaration'] = { fg = palette.orange, style = 'italic' },
    ['typescriptBraces'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.typemod.member.defaultLibrary'] = { fg = palette.green, style = 'bold' },
    ['@lsp.typemod.parameter.local'] = { fg = palette.orange, style = 'italic' },
    ['@lsp.mod.declaration'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.typemod.method.declaration'] = { fg = palette.white, style = 'NONE' },
    ['typescriptDestructureVariable'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.typemod.function.declaration.local'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.typemod.function.declaration.readonly'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.typemod.function.declaration.local.readonly'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.type.function'] = { fg = palette.green, style = 'bold' },
    ['@lsp.typemod.function.local'] = { fg = palette.green, style = 'bold' },
    ['@lsp.typemod.property.defaultLibrary'] = { fg = palette.white, style = 'NONE' },
    ['typescriptDOMDocProp'] = { fg = palette.white, style = 'NONE' },
    ['typescriptURLUtilsProp'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.typemod.member.local'] = { fg = palette.green, style = 'bold' },
    ['@tag.builtin'] = { fg = palette.aqua },
    ['tsxTagName'] = { fg = palette.aqua },
    ['tsxAttrib'] = { fg = palette.orange, style = 'italic' },
    ['tsxTag'] = { fg = palette.white, style = 'NONE' },
    ['typescriptTypeAnnotation'] = { fg = palette.white, style = 'NONE' },
    ['typescriptTypeReference'] = { fg = palette.aqua },
    ['typescriptParamImpl'] = { fg = palette.orange, style = 'italic' },
    ['tsxCloseTag'] = { fg = palette.white, style = 'NONE' },
    ['typescriptObjectLabel'] = { fg = palette.white, style = 'NONE' },
    ['@interface'] = { fg = palette.aqua },
    ['@lsp.typemod.interface.declaration'] = { fg = palette.aqua },
    ['typescriptInterfaceName'] = { fg = palette.aqua, style = 'NONE' },
    ['@lsp.typemod.member.declaration'] = { link = 'Identifier' },
    ['@lsp.typemod.function.declaration'] = { link = 'Function' },
    ['@lsp.typemod.function.readonly'] = { link = 'Function' },
    ['typescriptBOMHistoryProp'] = { fg = palette.white, style = 'NONE' },
    ['typescriptBOMWindowProp'] = { fg = palette.white, style = 'NONE' },
    ['@lsp.typemod.type.declaration'] = { fg = palette.aqua, style = 'NONE' },
    ['typescriptAliasDeclaration'] = { fg = palette.aqua, style = 'NONE' },
